...
second_check = pk.load(open("models/classifier.pickle", 'rb'))
third_check = pk.load(open("models/FRS/classifier.pickle", 'rb'))
fourth_check = pk.load(open("models/Severity/classifier.pickle", 'rb'))                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                

with open('models/cat_counter.pk', 'rb') as f:
    cat_counter = pk.load(f)

cat_list = [k for k, v in cat_counter.most_common()[:27]]
CLASS_INDEX_PATH = 'models/imagenet_class_index.json'
CLASS_INDEX = None
